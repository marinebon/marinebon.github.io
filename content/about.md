...
- Promote best practices (OBPs) in observations, data management, and applications to advance interoperability and data integration (DarwinCore), and publication of data in open-access databases (OBIS).
...
MBON's agenda is aligned with key international agreements and guidelines for evaluating changes in ocean biodiversity for sustainable development:
